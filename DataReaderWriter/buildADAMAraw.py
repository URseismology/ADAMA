...
wavetyps = [1, 2, 1, 2, 1, 2, 1, 2, 1, 2, 1, 2] # love-ral love-ral ...
usemethd = [1, 1, 2, 2, 1, 1, 1, 1, 1, 1, 1, 1] # aki3, aki3, aki1, aki1, ...
usecols = [2, 2, 2, 2, 1, 1, 4, 4, 3, 3, 5, 5] # phase, group, env, bessel
outlbls = ['cf', 'cf', 'co', 'co', 'u', 'u', 'env', 'env', 'bes', 'bes', 'rs', 'rs']
